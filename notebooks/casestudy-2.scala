...
// MAGIC ## this is a sample notebook for understanding ADB capabilities
...
val configs = Map(
  ...
  "fs.azure.account.oauth2.client.id" -> "5108a1c1-b69b-4dd1-8888-3f01ace75d20",
  "fs.azure.account.oauth2.client.secret" -> dbutils.secrets.get(scope = "training-scope", key = "appsecret"),
  "fs.azure.account.oauth2.client.endpoint" -> "https://login.microsoftonline.com/febb80d3-b942-426a-a2de-d266b3bc22d1/oauth2/token")

// COMMAND ----------

dbutils.fs.mount(
  source = "abfss://data@datalakecasestudy.dfs.core.windows.net/",
  mountPoint = "/mnt/data",
...
object SentimentDetector extends Serializable {
    val accessKey = "ce25ba850c014c8985d3cb02c2826f9c"
    val host = "https://datalakecasestudytext.cognitiveservices.azure.com/"
